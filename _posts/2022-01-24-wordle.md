...
$$ \textrm{fitness}(w) = -\sum_{i=1}^{\# guesses} \lvert \textrm{correct}(g_i, w) - c_i \rvert + \lvert \textrm{misplaced}(g_i, w) - m_i \rvert $$
...
[here](https://github.com/Dando18/wordle-puzzle) and ran for 5000 iterations 
...
These strategies are all great, but they ignore an essential fact: Wordle is an
